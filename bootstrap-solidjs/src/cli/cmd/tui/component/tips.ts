export const TIPS = [
  ...
  "Use {highlight}/undo{/highlight} to revert the last message and any file changes made by Bootstrap.",
  ...
  "Create {highlight}bootstrap.json{/highlight} in project root for project-specific settings.",
  "Place settings in {highlight}~/.config/bootstrap/bootstrap.json{/highlight} for global config.",
  ...
  "Bootstrap auto-handles OAuth for remote MCP servers requiring auth.",
  "Add {highlight}.md{/highlight} files to {highlight}.bootstrap/command/{/highlight} to define reusable custom prompts.",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input.",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight}).",
  "Add {highlight}.md{/highlight} files to {highlight}.bootstrap/agent/{/highlight} for specialized AI personas.",
  "Configure per-agent permissions for {highlight}edit{/highlight}, {highlight}bash{/highlight}, and {highlight}webfetch{/highlight} tools.",
  'Use patterns like {highlight}"git *": "allow"{/highlight} for granular bash permissions.',
  'Set {highlight}"rm -rf *": "deny"{/highlight} to block destructive commands.',
  'Configure {highlight}"git push": "ask"{/highlight} to require approval before pushing.',
  "Bootstrap auto-formats files using prettier, gofmt, ruff, and more.",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting.',
  "Define custom formatter commands with file extensions in config.",
  "Bootstrap uses LSP servers for intelligent code analysis.",
  "Create {highlight}.ts{/highlight} files in {highlight}.bootstrap/tool/{/highlight} to define new LLM tools.",
  "Tool definitions can invoke scripts written in Python, Go, etc.",
  "Add {highlight}.ts{/highlight} files to {highlight}.bootstrap/plugin/{/highlight} for event hooks.",
  "Use plugins to send OS notifications when sessions complete.",
  "Create a plugin to prevent Bootstrap from reading sensitive files.",
  "Use {highlight}bootstrap run{/highlight} for non-interactive scripting.",
  "Use {highlight}bootstrap run --continue{/highlight} to resume the last session.",
  "Use {highlight}bootstrap run -f file.ts{/highlight} to attach files via CLI.",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts.",
  "Run {highlight}bootstrap serve{/highlight} for headless API access to Bootstrap.",
  "Use {highlight}bootstrap run --attach{/highlight} to connect to a running server for faster runs.",
  "Run {highlight}bootstrap upgrade{/highlight} to update to the latest version.",
  "Run {highlight}bootstrap auth list{/highlight} to see all configured providers.",
  "Run {highlight}bootstrap agent create{/highlight} for guided agent creation.",
  "Use {highlight}/bootstrap{/highlight} in GitHub issues/PRs to trigger AI actions.",
  "Run {highlight}bootstrap github install{/highlight} to set up the GitHub workflow.",
  "Comment {highlight}/bootstrap fix this{/highlight} on issues to auto-create PRs.",
  "Comment {highlight}/oc{/highlight} on PR code lines for targeted code reviews.",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors.',
  "Create JSON theme files in {highlight}.bootstrap/themes/{/highlight} directory.",
  ...
  "Run {highlight}bootstrap debug config{/highlight} to troubleshoot configuration.",
  ...
  "Bootstrap is focused on Java and Python testing workflows.",
  "Use {highlight}/connect{/highlight} to configure LLM providers.",
