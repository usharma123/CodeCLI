...
function App() {
  ...
  createEffect(() => {
    ...
    if (route.data.type === "home") {
      renderer.setTerminalTitle("Bootstrap")
      return
    }
    ...
    if (route.data.type === "session") {
      ...
      renderer.setTerminalTitle(`BS | ${title}`)
    }
  })
  ...
  sdk.event.on(Installation.Event.Updated.type, (evt) => {
    toast.show({
      ...
      message: `Bootstrap updated to v${evt.properties.version}`,
      duration: 5000,
    })
  })
  ...
  sdk.event.on(Installation.Event.UpdateAvailable.type, (evt) => {
    toast.show({
      ...
      message: `Bootstrap v${evt.properties.version} is available. Run 'bootstrap upgrade' to update manually.`,
      duration: 10000,
    })
  })
