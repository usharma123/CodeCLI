...
describe("ToolExecutor", () => {
    ...
    mockTools = [
      {
        ...
        function: mock(async (args: any) => `Result: ${args.input}`),
      },
      {
        name: "write_file",
        ...
        function: mock(async (args: any) => `Wrote to ${args.path}`),
      },
    ];
  ...
  describe("validateToolSchemas", () => {
    ...
    it("should detect missing additionalProperties", () => {
      const toolsWithMissingProp: ToolDefinition[] = [
        {
          name: "bad_tool",
    ...
    it("should detect undefined required properties", () => {
      const toolsWithBadRequired: ToolDefinition[] = [
        {
          name: "bad_tool",
