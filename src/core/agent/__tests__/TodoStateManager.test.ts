...
describe("TodoStateManager", () => {
  ...
  describe("updateTodos", () => {
    it("should update todos with new list", () => {
      const todos = [
        { content: "Task 1", activeForm: "Doing Task 1", status: "pending" as const },
        { content: "Task 2", activeForm: "Doing Task 2", status: "in_progress" as const },
      ];
    ...
    it("should preserve existing IDs", () => {
      const todos = [
        { id: "my-custom-id", content: "Task 1", activeForm: "Doing Task 1", status: "pending" as const },
      ];
  ...
  describe("getInProgressTodo", () => {
    it("should return the in-progress todo", () => {
      const todos = [
        { content: "Task 1", activeForm: "Doing Task 1", status: "completed" as const },
        { content: "Task 2", activeForm: "Doing Task 2", status: "in_progress" as const },
        { content: "Task 3", activeForm: "Doing Task 3", status: "pending" as const },
      ];
    ...
    it("should return null when no todo is in progress", () => {
      const todos = [
        { content: "Task 1", activeForm: "Doing Task 1", status: "completed" as const },
        { content: "Task 2", activeForm: "Doing Task 2", status: "pending" as const },
      ];
  ...
  describe("markComplete", () => {
    it("should mark a todo as completed by ID", () => {
      const todos = [
        { id: "task-1", content: "Task 1", activeForm: "Doing Task 1", status: "in_progress" as const },
      ];
  ...
  describe("markInProgress", () => {
    it("should mark a todo as in-progress by ID", () => {
      const todos = [
        { id: "task-1", content: "Task 1", activeForm: "Doing Task 1", status: "pending" as const },
      ];
    ...
    it("should reset other in-progress todos to pending", () => {
      const todos = [
        { id: "task-1", content: "Task 1", activeForm: "Doing Task 1", status: "in_progress" as const },
        { id: "task-2", content: "Task 2", activeForm: "Doing Task 2", status: "pending" as const },
      ];
