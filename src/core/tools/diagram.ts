...
export const diagramTools: ToolDefinition[] = [
  {
    ...
    description:
      "Analyze a codebase structure and generate a Mermaid diagram. Returns the file structure and key entrypoint contents for generating an architecture diagram.",
    parameters: {
      type: "object",
      properties: {
        root_dir: {
    ...
    function: async (input: GenerateMermaidDiagramInput): Promise<string> => {
      ...
      const outputFormat: OutputFormat = input.output_format || "png";
