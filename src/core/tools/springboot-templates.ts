import { SpringBootComponentType } from "../../utils/springboot-detector.js";
 ...
 */
export function generateControllerTest(
  className: string,
  packageName: string,
 ...
 */
function generateKotlinControllerTest(
  className: string,
  packageName: string
): string {
  const serviceName = className.replace("Controller", "Service");
 ...
 * @returns Complete test class content
 */
export function generateServiceTest(
  className: string,
  packageName: string,
  language: Language = "java"
): string {
 ...
 * @returns Complete Kotlin test class content
 */
function generateKotlinServiceTest(
  className: string,
  packageName: string
): string {
  const repositoryName = className.replace("Service", "Repository");
 ...
 * @returns Complete Kotlin test class content
 */
function generateKotlinRepositoryTest(
  className: string,
  packageName: string,
  entityName?: string
): string {
 ...
 * @returns Complete Kotlin test class content
 */
function generateKotlinIntegrationTest(
  applicationClassName: string,
  packageName: string
): string {
  const testClassName = `${applicationClassName}IntegrationTest`;
 ...
 * @returns Complete Kotlin test class content
 */
function generateKotlinComponentTest(
  className: string,
  packageName: string
): string {
  const testClassName = `${className}Test`;
 ...
 * @returns Complete test class content
 */
export function generateSpringBootTest(
  componentType: SpringBootComponentType,
  className: string,
  packageName: string,
  language: Language = "java",
  entityName?: string
