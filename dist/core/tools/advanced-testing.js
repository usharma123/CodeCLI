...
const generateIntegrationTestDefinition = {
    name: "generate_integration_test",
    description: "Generate integration tests that verify interactions between multiple components or modules. Analyzes component dependencies and creates tests with mocks/stubs.",
    parameters: {
        type: "object",
        properties: {
            components: {
...
const generateE2ETestDefinition = {
    name: "generate_e2e_test",
    description: "Generate end-to-end test scenarios that simulate real user journeys. Supports web applications with Playwright/Selenium patterns.",
    parameters: {
        type: "object",
        properties: {
            user_journey: {
                type: "string",
                description: "Description of the user journey to test (e.g., 'User logs in, adds item to cart, checks out')",
            },
            app_type: {
                type: "string",
                enum: ["web", "api", "cli"],
...
const generateAPITestDefinition = {
    name: "generate_api_test",
    description: "Generate comprehensive API test suites including endpoint testing, schema validation, and contract testing.",
    parameters: {
        type: "object",
        properties: {
            api_spec: {
                type: "string",
                description: "API specification (OpenAPI/Swagger file path or endpoint documentation)",
            },
            endpoints: {
                type: "array",
                items: { type: "string" },
