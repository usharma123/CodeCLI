...
const generateTestsFromPRDDefinition = {
    name: "generate_tests_from_prd",
    description: "Generate test code from PRD test cases. Takes structured test cases (from parse_prd) and creates executable test files.",
    parameters: {
        type: "object",
        properties: {
            test_cases_file: {
...
const generatePerformanceTestDefinition = {
    name: "generate_performance_test",
    description: "Generate performance and load tests for APIs or applications. Creates test scripts with configurable load patterns.",
    parameters: {
        type: "object",
        properties: {
            target_url: {
