    ...
    function: async (input) => {
        ...
        try {
            ...
            if (fileExists && currentContent) {
                ...
                console.log(`  ${colors.gray}└ Overwrite ${colors.bold}${input.path}${colors.reset}${colors.gray} (${totalLines} lines)${colors.reset}`);
                console.log();
                ...
                console.log(`  ${colors.gray}└ Create ${colors.bold}${input.path}${colors.reset}${colors.gray} (${totalLines} lines)${colors.reset}`);
...
const editFileDefinition = {
    ...
    function: async (input) => {
        ...
        try {
            ...
            console.log(`  ${colors.gray}└ Updated ${colors.bold}${input.path}${colors.reset}${colors.gray} - Changes: ${summary}${colors.reset}`);
            console.log();
