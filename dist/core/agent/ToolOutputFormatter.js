...
export class ToolOutputFormatter {
    ...
    static DEFAULT_OUTPUT_TOOLS = new Set([
        "run_command",
        "run_tests",
     ...
     */
    formatForDisplay(functionName, args, result) {
     ...
     */
    emitOutput(functionName, args, result, displayedResult) {
