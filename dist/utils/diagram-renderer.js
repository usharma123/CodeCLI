 ...
 */
export function extractMermaidCode(content) {
 ...
 */
export function isSupportedDiagramType(mermaidCode) {
 ...
 */
function createBox(label, minWidth = 0) {
    const padding = 1;
 ...
 */
function renderToAscii(diagram) {
    const { nodes, edges, direction, subgraphs } = diagram;
    if (nodes.size === 0) {
 ...
 */
export async function renderMermaidToAscii(mermaidCode) {
 ...
 */
export function formatDiagramResult(result) {
