...
export function Header() {
    ...
    return (<box borderStyle="single" borderBottom paddingX={1} flexDirection="row" justifyContent="space-between">
      ...
      {/* Right: Shortcuts */}
      <box flexDirection="row" gap={2}>
        {shortcuts().map((shortcut) => (<text color={theme().colors.muted}>{shortcut}</text>))}
      </box>
    </box>);
}
