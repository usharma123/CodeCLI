...
export function ReasoningPart(props) {
    ...
    return (<box flexDirection="column" borderStyle="single" borderColor={theme().colors.muted} padding={1}>
      {/* Header */}
      <box flexDirection="row" justifyContent="space-between" marginBottom={isCollapsed() ? 0 : 1}>
      ...
      {/* Content */}
      <Show when={!isCollapsed()} fallback={<text color={theme().colors.muted} italic>
            {summary()}
          </text>}>
