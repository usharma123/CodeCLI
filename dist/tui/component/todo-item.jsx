...
export function TodoList(props) {
    ...
    return (<box flexDirection="column" borderStyle="single" borderColor={theme().colors.border} marginY={1} padding={1}>
      ...
      <For each={props.todos}>
        {(todo) => {
            ...
            return (<box flexDirection="row">
              ...
              <text color={todo.status === "completed"
                    ? theme().colors.muted
                    : theme().colors.foreground} strikethrough={todo.status === "completed"} wrap="truncate">
