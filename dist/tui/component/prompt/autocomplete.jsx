...
export function Autocomplete(props) {
    ...
    return (<box flexDirection="column" borderStyle="single" borderColor={theme().colors.accent} marginBottom={1} maxHeight={10}>
      <For each={filteredCommands()}>
        {(cmd, index) => (<box paddingX={1} backgroundColor={index() === selectedIndex() ? theme().colors.accent : undefined}>
