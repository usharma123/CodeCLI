...
export function PlanConfirm({ plan, onApprove, onReject, onModify, }) {
    ...
    return (<Box flexDirection="column" borderStyle="round" borderColor="cyan" paddingX={1} paddingY={0}>
      {/* Header */}
      <Box marginBottom={1}>
      ...
      {showModifyInput && (<Box flexDirection="column" marginTop={1} borderStyle="single" borderColor="yellow" paddingX={1}>
          <Box marginBottom={1}>
      ...
      {/* Hint */}
      {!showModifyInput && (<Box marginTop={1}>
          <Text dimColor>
