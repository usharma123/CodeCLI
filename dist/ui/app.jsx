...
Do NOT start implementation until I approve the plan.`;
    ...
    return (<Box flexDirection="row">
      <Box flexDirection="column" flexGrow={1}>
        ...
        {/* Processing status */}
        {isProcessing && (<StatusBar message={statusMessage || "thinking..."} isProcessing={isProcessing} startTime={processingStartTime || undefined}/>)}
        ...
        {/* Confirmation dialog */}
        {confirmState && (<Box marginBottom={1}>
            <Confirm message={confirmState.message} onConfirm={handleConfirm} onCancel={handleCancel}/>
          </Box>)}

        {/* Plan confirmation dialog */}
        {pendingPlan && (<Box marginBottom={1}>
            <PlanConfirm plan={pendingPlan} onApprove={handlePlanApprove} onReject={handlePlanReject} onModify={handlePlanModify}/>
          </Box>)}

        {/* Input */}
        <InputBox onSubmit={handleSubmit} isDisabled={isProcessing || !!confirmState || !!expandedOutputId || !!pendingPlan} sessionNum={sessionNum} resetToken={inputResetToken} isPlanningMode={isPlanningMode}/>
      </Box>
    </Box>);
}
